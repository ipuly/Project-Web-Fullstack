<template>
    <div>
        <div class="row justify-content-center my-5 w-100">
            <div v-show="!success" class="col-8 p-5 rounded border border-primary">
                <h2 class="text-center mb-5">Add Student</h2>
            ...
            <SuccessAddComponentVue v-show="success"></SuccessAddComponentVue>
        </div>
    </div>
</template>
...
import SuccessAddComponentVue from './SuccessAddComponent.vue';
