<template>
    <div>
        ...
        <div v-show="!success">
            <router-link to="/">
                <button type="submit" class="btn btn-primary mt-3 ml-3 font-weight-bold">
                    <font-awesome-icon icon="fa-solid fa-left-long" /> Back</button>
            </router-link>

            <div class="row justify-content-center my-5 w-100">
                <div class="col-8 p-5 rounded border border-primary">
