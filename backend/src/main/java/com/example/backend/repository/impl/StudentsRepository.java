...
public class StudentsRepository implements IStudentsRepository {
    ...
    public Students insertStudents(Students students) {
        ...
        jdbcTemplate.update(query,
                new Object[] { students.getDeskripsi_diri(), students.getEmail(), students.getHard_skill(),
                        students.getInterest(), students.getJenis_kelamin(), students.getNama(),
                        students.getSoft_skill(),
                        students.getUmur() });
        return students;
    }
